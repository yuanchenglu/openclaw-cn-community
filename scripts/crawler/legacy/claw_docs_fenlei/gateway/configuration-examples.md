...
Source: https://clawd.org.cn/gateway/configuration-examples.html

# 配置示例

以下示例与当前配置架构保持一致。详尽的参考说明和字段注释请参见[配置](/gateway/configuration.html)。
...
* 更深入的设置说明请参见[提供商](/channels/whatsapp.html)和[故障排除](/gateway/troubleshooting.html)。