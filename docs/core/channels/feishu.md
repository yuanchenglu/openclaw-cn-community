...
Source: https://clawd.org.cn/channels/feishu.html
...
![创建企业自建应用](/assets/feishu-step2-create-app.DXKaT3HN.png)
...
![获取应用凭证](/assets/feishu-step3-credentials.CysJE0tQ.png)
...
![配置应用权限](/assets/feishu-step4-permissions.Dd7QnI8v.png)
...
![启用机器人能力](/assets/feishu-step5-bot-capability.6oZInyhk.png)
...
![配置事件订阅](/assets/feishu-step6-event-subscription.Vi5oaaJ9.png)
...
| `channels.feishu.allowFrom` | 私聊白名单（open\_id 列表） | - |
